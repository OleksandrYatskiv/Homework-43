...
function validateForm(productTitle) {
    ...
    if (!fullName || !city || !postOffice || !payment || !amount) {
        alert('Please fill in all required fields!');
    } else {
        displayOrderDetails(fullName, city, postOffice, payment, amount,productTitle);
    };

}

function displayOrderDetails(fullName, city, postOffice, payment, amount,productTitle) {
